...
global.reloadHandler = function () {
  ...
  conn.welcome = 'welcome gays, @user!\nSelamat datang di grup @subject\n\njangan lupa baca des groupnya\n@desc' //terserah loh ganti atau gak
  conn.bye = 'waduh kena mental dia jangan ke sini lagi ya @user'
  conn.spromote = '@user succes *admin*'
  conn.sdemote = '@user succes bukan *admin*'
